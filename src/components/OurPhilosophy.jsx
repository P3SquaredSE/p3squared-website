...

        {
            ...
            blocks: [
                ...
                { type: "numbers", items: [
                    ...
                    `<br>Our Team:</b> Dedicated to bringing hospitals together to centralize supply ordering for rural hospitals and then disperse those supplies to each respective facility. This decreases supply costs and supports better deliveries.`
                    ],
                },
            ],
        },
